...
.. document:: Persistency Feature Architecture Inspection Checklist
   :id: doc__arch_inspection_persistency
   :status: draft
   :security: NO
   :safety: ASIL_B
   :tags: persistency
...
Persistency Feature Architecture Inspection Checklist
=====================================================
