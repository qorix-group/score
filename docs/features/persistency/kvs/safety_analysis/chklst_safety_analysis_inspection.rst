...
.. document:: Persistency Feature Safety Analysis Inspection Checklist
   :id: doc__saf_ana_inspec_feat_persistency
   :status: draft
   :security: NO
   :safety: ASIL_B
   :tags: persistency
...
=============================================
   ...
   **Checklist**
   ...
   .. list-table:: Persistency Feature Safety Analysis Checklist
      :header-rows: 1
